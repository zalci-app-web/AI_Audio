        ...
        <section className="container mx-auto px-4 py-16">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-gray-400">
              Discover our latest AI-generated masterpieces. High-quality audio tracks ready for your next project.
            </p>
          </div>

          {!songs?.length ? (
            <div className="flex h-64 items-center justify-center rounded-2xl border border-white/10 bg-white/5">
              <p className="text-gray-400">No songs available at the moment.</p>
            </div>
          ) : (
