...
export const dictionaries = {
    en: {
        ...
        about: {
            ...
            tagline: '"The power of Generative AI, for every creator." No high-spec PC or complex prompts required.',
            conceptTitle: 'About Zalci Audio',
            conceptDesc: '"I want to use high-performance generative AI, but my PC specs aren\'t enough..." "It\'s honestly a hassle to repeat generations until I\'m satisfied."\n\nZalci Audio is a store that carefully selects and provides sounds that we believe are "the one" by utilizing the latest AI technology on behalf of such creators.\n\nAll you have to do is find your favorite sound from the library and download it. Leave the "tedious parts" of production to us and focus on your creative work.',
            roadmapTitle: 'Current Lineup and Future Expansion',
            roadmapDesc: 'Currently, our store provides materials mainly in the easy-to-handle and lightweight mp3 format. However, Zalci Audio does not stop here. In the future, we plan to implement the following updates to meet the more advanced needs of creators.\n\n- Addition of high-quality WAV format (for professional production)\n- Seamlessly looped materials (for smoother game implementation)\n- Sale of MIDI data (for those who want to freely customize melodies)\n\nAs a library that continues to grow, we support your project.',
            messageTitle: 'From a Current Game Developer\'s Perspective',
            messageDesc: 'As a student learning game development (Unity/C++), I am shaping the "sounds I wanted now" myself. I am aiming to be a material shop that draws out the maximum potential of AI and that developers can use without stress.',
        },
        purchaseModal: {
